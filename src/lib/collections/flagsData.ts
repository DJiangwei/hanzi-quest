...
const RAW_FLAGS: RawFlag[] = [
  ...
  { slug: 'israel', iso2: 'il', continent: 'asia', nameZh: '以色列', nameEn: 'Israel', capitalZh: '特拉维夫', capitalEn: 'Tel Aviv', loreZh: '有很咸的死海。', loreEn: 'Home of the salty Dead Sea.', rarity: 'rare', dropWeight: 2 },
